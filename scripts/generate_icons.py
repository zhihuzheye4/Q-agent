...
def icon_settings_active() -> str:
    """L3 复杂：齿轮（Heroicons cog-6-tooth outline，6 齿明显 + 中心圆）"""
    settings_outer = (
        "M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281"
        "c.063.374.313.686.645.87.074.04.147.083.22.124.311.169.69.238 1.035.114l1.165-.428"
        "a1.125 1.125 0 0 1 1.173.498l1.297 2.247c.264.455.157 1.034-.248 1.378l-.972.823"
        "c-.27.23-.404.576-.348.925.029.18.052.36.068.547.016.181.024.365.024.548"
        "0 .183-.008.367-.024.548a1.4 1.4 0 0 0 .06.316l.008.028c.056.35.277.659.594.85l.972.823"
        "c.405.344.512.923.248 1.378l-1.297 2.247a1.125 1.125 0 0 1-1.173.498l-1.165-.428"
        "a1.125 1.125 0 0 0-1.035.114c-.073.041-.146.084-.22.124-.332.184-.582.497-.645.871"
        "l-.213 1.281c-.09.542-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281"
        "c-.062-.374-.312-.686-.644-.87a3.71 3.71 0 0 1-.22-.124c-.312-.169-.69-.238-1.035-.114"
        "l-1.165.428a1.125 1.125 0 0 1-1.173-.498l-1.297-2.247a1.125 1.125 0 0 1 .248-1.378"
        "l.972-.823c.27-.23.404-.576.348-.925a6.704 6.704 0 0 1-.068-.547"
        "c-.016-.181-.024-.365-.024-.548 0-.183.008-.367.024-.548.016-.183.04-.36.068-.547"
        ".056-.35-.078-.696-.348-.925l-.972-.823c-.405-.344-.512-.923-.248-1.378L4.375 4.95"
        "c.264-.455.86-.6 1.378-.348l1.165.428c.345.124.723.055 1.035-.114.073-.04.146-.084.22-.124"
        ".332-.184.582-.496.644-.87l.213-1.281Z"
    )
    body = group(
        [
            path(settings_outer),
